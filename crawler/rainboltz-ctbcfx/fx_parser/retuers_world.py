...
if __name__ == '__main__':
    '''
    olddata = pd.read_csv('/Users/xiechangrun/Desktop/rt_worldNews.csv',encoding = 'utf-8')
    ...
    MainPage = 'http://www.reuters.com/news/archive/worldNews?view=page&page='
    ...
    '''
    data.to_csv('/Users/xiechangrun/Desktop/rt_worldNews.csv',encoding = 'utf-8',index = None)
